...
plotmafSummary(primary_mafs, showBarcodes = T, textSize = 0.5)
dev.off()


pdf('../figures/Strelka2_immortalizedMafSummary.pdf')
plotmafSummary(immortalized_mafs, showBarcodes = T, textSize = 0.5)
dev.off()
...
pdf("../figures/Strelka2_NF1_variants.pdf")
