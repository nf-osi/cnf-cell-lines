...
**note: the struck-through section below was actually an error identified in code review, and is not accurate**
...
<s>Other than the weird results with 28NF, the remainder of</s> the results are encouraging. All of the immortalized cell lines cluster with their non-immortalized counterparts, and the cell lines from the same patient (e.g. 97.2, 98.4) cluster together. This indicates that the immortalized cells maintain some level of genetic fidelity despite the genetic changes required to engineer these cell lines. 
